...
const mockExams = [
  { id: 1, course: "CSC 401 - Database Systems", date: "2026-02-15", time: "9:00 AM", venue: "LT1" },
  { id: 2, course: "CSC 403 - Software Engineering", date: "2026-02-18", time: "2:00 PM", venue: "LT2" },
  { id: 3, course: "MTH 301 - Numerical Analysis", date: "2026-02-22", time: "9:00 AM", venue: "LT3" },
];
...
const mockStudyGroups = [
  { id: 1, name: "CSC 401 Study Group", members: 45, nextSession: "Tomorrow, 4PM" },
  { id: 2, name: "Final Year Project Help", members: 23, nextSession: "Friday, 2PM" },
  { id: 3, name: "MTH 301 Problem Solving", members: 67, nextSession: "Saturday, 10AM" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-display font-bold">Academic Tools</h1>
            <p className="text-sm text-muted-foreground">Resources to boost your academic success</p>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="gpa" className="space-y-6">
        <TabsList className="bg-muted/50 p-1 flex-wrap h-auto">
          <TabsTrigger value="gpa" className="gap-1">
          ...
          <TabsTrigger value="studygroups" className="gap-1">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <Card className="glass-card lg:col-span-2">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Calculator className="w-5 h-5 text-academic" />
                  Course Entry
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  <Button onClick={addCourse} variant="hero">
                    ...
                    <div key={course.id} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                      <div className="flex items-center gap-4">
                        ...
                        <Badge className={`
                          ...
                          ${course.grade === "C" ? "bg-warning" : ""}
                          ${["D", "E", "F"].includes(course.grade) ? "bg-destructive" : ""}
                        `}>
                          {course.grade}
                        </Badge>
                      </div>
            ...
            <Card className="glass-card">
              ...
              <CardContent className="text-center">
                <div className="w-32 h-32 rounded-full gradient-bg flex items-center justify-center mx-auto mb-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold">{courses.reduce((s, c) => s + c.units, 0)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <Badge variant="secondary">
                      {parseFloat(calculateGPA()) >= 4.5 ? "First Class" :
                       ...
                       parseFloat(calculateGPA()) >= 1.5 ? "Third Class" : "Pass"}
                    </Badge>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div key={exam.id} className={`p-4 rounded-xl border ${isUrgent ? "border-destructive/50 bg-destructive/5" : "border-border/50 bg-muted/30"}`}>
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="text-center md:text-right">
                        <div className={`text-3xl font-display font-bold ${isUrgent ? "text-destructive" : "text-primary"}`}>
                          {daysLeft}
                        </div>
              ...
              {mockStudyGroups.map((group) => (
                <Card key={group.id} className="border bg-muted/30">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-xl bg-hostel/10 flex items-center justify-center">
                          <Brain className="w-6 h-6 text-hostel" />
                        </div>
                        <div>
